		 ...
		 <div class=" cart-items">
		  ...
		  <ul class="cart-header">
		   <div class="close1"> </div>
			<li class="ring-in"><a href="single.html" ><img src="resources/images/{{jsonData.productId}}-0.jpg" class="img-responsive" alt=""></a>
			</li>
			<li><span>{{jsonData.productName}}</span></li>
			<li><span>$ {{jsonData.productPrice}}</span></li>
