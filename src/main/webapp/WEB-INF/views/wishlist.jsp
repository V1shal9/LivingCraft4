...
<div class="container">
	<h6 class="dress"><a href="index.html">Home</a> <i> </i> WishList </h6>
</div>
<div class="back">
	<h2>BUY NOW</h2>
</div>
		 ...
		 <div class=" cart-items">
		  ...
		  <ul class="cart-header" ng-repeat="p in jsonData">
		   <div class="close1"> </div>
			...
			<li><span><a href="deletewishlist-{{p.wishListId}}">Remove</a></span></li>
			<div class="clearfix"> </div>
			</ul>
			<ul><a href="buynow-{{jsonData.productId}}?userId=1" class="add-cart cart-check">BUY NOW</a>
			<a href="addtocart-{{jsonData.productId}}?userId=1" class="add-cart cart-check">ADD TO CART</a></ul>
